...
place_setaspect("lone_tower_2", 0, 3, tileset..":pillar_bot")
place_setaspect("lone_tower_2", 0, 4, tileset..":mosaic_a")
place_setaspect(zone, 22, 5, tileset..":mosaic_a")
loadfile("build/tools/link.lua")("lone_tower_2", 0, 4, zone, 22, 5)

place_setaspect("lone_tower_2", 8, 3, tileset..":pillar_bot")
place_setaspect("lone_tower_2", 8, 4, tileset..":mosaic_a")
